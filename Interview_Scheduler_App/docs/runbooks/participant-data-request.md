# Handle participant data requests

## Purpose

Export or remove participant data consistently.

## Scope

- verify requester identity
- include interview relationships
- record completion without sensitive payloads
