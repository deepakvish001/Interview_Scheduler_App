# Diagnose failing health checks

## Purpose

Separate dependency failures from application boot failures.

## Scope

- inspect application logs
- test database and queue dependencies
- compare current release configuration
