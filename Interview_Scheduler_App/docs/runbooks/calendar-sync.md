# Recover calendar synchronization failures

## Purpose

Restore provider sync while protecting the local interview record.

## Scope

- classify authentication versus validation failures
- retry idempotently
- reconcile remote event identifiers
