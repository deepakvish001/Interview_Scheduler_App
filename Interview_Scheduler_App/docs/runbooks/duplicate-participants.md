# Resolve duplicate participant records

## Purpose

Merge duplicate identities without losing interview history.

## Scope

- select canonical participant
- repoint join records transactionally
