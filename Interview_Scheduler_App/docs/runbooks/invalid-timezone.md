# Correct invalid timezone submissions

## Purpose

Repair affected records and prevent repeated invalid input.

## Scope

- identify originating client
- map only confirmed identifiers
- notify affected users if display changed
