# Recover failed reminder deliveries

## Purpose

Guide operators through identifying and retrying failed reminder jobs.

## Scope

- confirm interview is still active
- inspect delivery attempts and provider response
- retry once with the original idempotency key
