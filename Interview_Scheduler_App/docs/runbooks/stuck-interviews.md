# Resolve interviews stuck in an active state

## Purpose

Describe safe correction of lifecycle state after end time.

## Scope

- verify stored timestamps
- check background job health
- record any manual correction
