# Respond to clock drift

## Purpose

Protect scheduling decisions when host clocks disagree.

## Scope

- compare trusted time source
- pause time-sensitive workers if needed
- verify timestamps after correction
