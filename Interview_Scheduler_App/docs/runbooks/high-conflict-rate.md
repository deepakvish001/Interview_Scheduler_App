# Investigate elevated scheduling conflicts

## Purpose

Determine whether conflict spikes reflect load or faulty time handling.

## Scope

- segment by timezone and client
- sample rejected ranges
- compare buffer configuration
