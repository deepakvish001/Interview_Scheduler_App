# Reschedule interview test plan

## Purpose

Cover safe updates without corrupting unrelated records.

## Scope

- only target interview changes
- participant set replacement
- notification enqueue after commit
