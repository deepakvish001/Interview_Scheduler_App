# Derive lifecycle status consistently

## Purpose

Create one definition for upcoming, active, completed, and cancelled.

## Scope

- timestamp-based transitions
- cancelled state precedence
- time-zone independent logic
