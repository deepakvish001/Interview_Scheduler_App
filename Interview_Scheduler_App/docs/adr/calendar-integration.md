# Isolate calendar providers behind adapters

## Purpose

Prevent provider-specific APIs from leaking into domain logic.

## Scope

- provider-neutral event contract
- sync identifiers stored separately
- retry-safe create and update operations
