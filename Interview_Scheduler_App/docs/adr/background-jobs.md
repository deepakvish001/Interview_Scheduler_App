# Standardize background job contracts

## Purpose

Define how asynchronous work receives and validates inputs.

## Scope

- record identifiers instead of objects
- idempotency requirements
- discard behavior for missing records
