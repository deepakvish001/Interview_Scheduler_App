# Represent cancellation as state

## Purpose

Preserve cancelled interview history rather than deleting records.

## Scope

- cancelled timestamp and actor
- excluded from active schedules
