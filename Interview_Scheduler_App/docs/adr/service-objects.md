# Use service objects for scheduling workflows

## Purpose

Move multi-record scheduling operations out of controllers.

## Scope

- one public entry point per workflow
- transactions around interview and participant changes
- domain failures returned without redirects
